...
(library Library_1
	...
	(patternDef "LEDC1608X110N" (originalName "LEDC1608X110N")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(line (pt 0.8 0.85) (pt -1.6 0.85) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.6 0.85) (pt -1.6 -0.85) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.6 -0.85) (pt 0.8 -0.85) (width 0.2))
		)
	)
	(symbolDef "APTD1608LVBC_D" (originalName "APTD1608LVBC_D")
	...
	(compDef "APTD1608LVBC_D" (originalName "APTD1608LVBC_D") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "APTD1608LVBC_D"))
		(attachedPattern (patternNum 1) (patternName "LEDC1608X110N")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "604-APTD1608LVBCD")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Kingbright/APTD1608LVBC-D?qs=6oMev5NRZMEfNSg5xIhlKA%3D%3D")
		(attr "Manufacturer_Name" "Kingbright")
		(attr "Manufacturer_Part_Number" "APTD1608LVBC/D")
		(attr "Description" "Blue 470nm LED Indication - Discrete 2.65V 0603 (1608 Metric)")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/APTD1608LVBC_D.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "APTD1608LVBC_D.stp")
