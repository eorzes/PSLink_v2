...
(library Library_1
	...
	(symbolDef "DFE322520FD-4R7M=P2" (originalName "DFE322520FD-4R7M=P2")
	...
	(compDef "DFE322520FD-4R7M=P2" (originalName "DFE322520FD-4R7M=P2") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "DFE322520FD-4R7M=P2"))
		...
		(attr "<Hyperlink>" "https://search.murata.co.jp/Ceramy/image/img/P02/J(E)TE243A-9104.pdf")
		(attr "<Component Height>" "2")
		(attr "<STEP Filename>" "DFE322520FD-4R7M=P2.stp")
