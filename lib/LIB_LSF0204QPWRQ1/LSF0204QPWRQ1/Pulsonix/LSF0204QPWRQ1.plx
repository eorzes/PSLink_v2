...
//1476556/1532278/2.50/14/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LSF0204QPWRQ1" (originalName "LSF0204QPWRQ1")
	...
	(compDef "LSF0204QPWRQ1" (originalName "LSF0204QPWRQ1") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "14" (pinName "VREF_B") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "EN") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LSF0204QPWRQ1"))
		...
		(attr "Mouser Part Number" "595-LSF0204QPWRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LSF0204QPWRQ1?qs=w%2Fv1CP2dgqqt88p%2F1xId1A%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LSF0204QPWRQ1")
		(attr "Description" "Automotive 4-Bit Bidirectional Multi-Voltage Level Translator for Open-Drain or Push- Pull Interface")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/lsf0204-q1")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "LSF0204QPWRQ1.stp")
