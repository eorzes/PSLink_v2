...
(library Library_1
	...
	(compDef "TCA9543ADR" (originalName "TCA9543ADR") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "__INT0") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "11" (pinName "__INT") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "8" (pinName "__INT1") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/tca9543a")
		(attr "Height" "1.75 mm")
	)
